...
@csv_bp.route('/travel_times', methods=['GET'])
def travel_times():
    return load_csv_file('travel_times')

@csv_bp.route('/mis_tracked_stops', methods=['GET'])
def mistracked_stops():
    return load_csv_file('mis_tracked_stops')

@csv_bp.route('/underperforming_regulatory_stops', methods=['GET'])
